...
// Formats a number in the format of 1M , 140K , 1.4B, etc.
  ...
  return (
    ...
    >
      <a href={`/watch?v=${id}`} className="relative aspect-video">
        <img
          src={thumbnailUrl}
          className={`block w-full h-full transition-[border-radius] duration-200 object-cover ${
        ...
        <video
          ...
          playsInline
          src={videoUrl}
          className={`block h-full absolute object-cover inset-0 transition-opacity duration-200 ${
